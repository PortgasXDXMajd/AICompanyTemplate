...
|---|---|---|---|
| CEO | Human | Goal, priorities, approvals | The person in the chat |
| Chief of Staff | Default session | Routing, `ROADMAP.md`, `REVIEW.md`, `context/`, `routines/` | `claude` |

<!-- Employee rows look like:
| growth-marketer | Employee | `customers/`, `work/marketing/` | delegated automatically, or `claude --agent growth-marketer` |
-->
